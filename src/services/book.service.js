...
function save(book) {
    if (book.id) return DbService.put(KEY, book);
        ...
        const bookToSave = {
            ...
            authors:book.authors || ['Andrey'],
            description:book.subtitle || 'this is a desc!',
            ...
            reviews:[],
            subtitle:book.subtitle || 'this is a subtitle!',
            thumbnail:book.imageLinks.thumbnail ,
            title:book.title  
        }
        return DbService.post(KEY, bookToSave)

    }

    // console.log('book.voulme',book);
}
